...
function onSpeak(e){
    chute = parseInt(e.results[0][0].transcript) // salva o valor do chute registrado na variável chute
...
recognition.addEventListener('end', () => {recognition.start()})//reinicia a escuta após o término da instrução